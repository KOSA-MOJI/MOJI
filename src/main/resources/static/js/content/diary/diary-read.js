...
function preparePageTransition(direction, oldPage, newPage) {
    ...
    const frontContent = direction === 'right' ?createRightChild(oldPage).outerHTML: createLeftChild(oldPage).outerHTML;
    const backContent = direction === 'right' ? createLeftChild(newPage).outerHTML : createRightChild(newPage).outerHTML;
